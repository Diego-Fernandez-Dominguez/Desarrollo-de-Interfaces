...
const ChatApp = () => {
  ...
  useEffect(() => {
    ...
    // Reemplaza con la URL de tu App Service en Azure (ej: https://ejercicio1chatdiegofd-huhpawhwhvdse4hz.spaincentral-01.azurewebsites.net/chatHub)
    const newConnection = new signalR.HubConnectionBuilder()
      .withUrl("https://ejercicio1chatdiegofd-huhpawhwhvdse4hz.spaincentral-01.azurewebsites.net/chatHub")
